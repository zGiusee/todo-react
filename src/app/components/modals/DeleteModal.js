export default function DeleteModal({ onDelete, onCancel, text }) {
  return (
    <>
        ...
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
              <h3 className="text-2xl font-semibold">Eliminazione attività</h3>
            </div>
            {/*body*/}
            <div className="relative px-6  py-4 flex-auto">
              <p className="my-4 text-blueGray-500 text-md leading-relaxed">
                {/* Body content */}
                Sei sicuro di voler eliminare la seguente attività "{text}"?
              </p>
            </div>
            {/*footer*/}
